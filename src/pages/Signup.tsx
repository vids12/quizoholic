            ...
            <div className="md:flex">
                <div className="w-full p-3 px-6 py-10">
                    ...
                    <div className="mt-3 relative">
                        <span className="absolute p-1 bottom-8 ml-2 bg-white text-gray-400 z-0">Name</span>
                        <input type="text" ref={nameRef} className="h-12 px02 w-full border-2 rounded focus:outline-none focus:border-indigo-600" />
                    </div>
