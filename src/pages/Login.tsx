...
import { Alert, Spinner } from '../components/index'
            ...
            <div className="md:flex">
              <div className="w-full p-3 px-6 py-10">
                <div className="text-center">
                  <span className="text-xl text-gray-700">Log In</span>
                </div>
                {loading === userStatus.ERROR && (
                ...
                <div className="mt-4">
                  <button
                    className="h-12 w-full bg-indigo-600 text-white rounded hover:bg-indigo-700 focus:outline-none"
